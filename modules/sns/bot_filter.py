...
def _filter_medias_not_liked(media_items):
    """Function `_filter_medias_not_liked` docstring."""
    not_liked_medias = []
...
def _filter_medias_not_commented(self, media_items):
    """Function `_filter_medias_not_commented` docstring."""
...
def _filter_medias_nlikes(media_items, max_likes_to_like, min_likes_to_like):
    """Function `_filter_medias_nlikes` docstring."""
    filtered_medias = []
    for media in media_items:
...
def _get_media_ids(media_items):
    """Function `_get_media_ids` docstring."""
    result = []
    for media in media_items:
        if "id" in media:
...
def search_stop_words_in_user(self, user_info):
    """Function `search_stop_words_in_user` docstring."""
    text = ""
...
def search_blacklist_hashtags_in_media(self, media_id):
    """Function `search_blacklist_hashtags_in_media` docstring."""

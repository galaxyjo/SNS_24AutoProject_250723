...
from typing import SupportsIndex, SupportsInt, TypeAlias, TypeVar, overload
...
from numpy._typing import _Shape, _ShapeLike
...
_StringDTypeOrUnicodeArray: TypeAlias = (
    np.ndarray[_Shape, np.dtype[np.str_]] | np.ndarray[_Shape, np.dtypes.StringDType]
)
...
@overload
def lstrip(
    a: _StringDTypeSupportsArray, chars: None | _StringDTypeSupportsArray = ...
) -> _StringDTypeArray: ...
@overload

...
def _construction_repr(
    dtype: np.dtype[Any], include_align: bool = False, short: bool = False
) -> str: ...
...
@overload
def _unpack_field(
    dtype: np.dtype[Any], offset: int, title: _T
) -> tuple[np.dtype[Any], int, _T]: ...
@overload
def _unpack_field(
    dtype: np.dtype[Any], offset: int, title: None = None
) -> tuple[np.dtype[Any], int, None]: ...

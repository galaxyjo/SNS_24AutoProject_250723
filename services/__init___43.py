    ...
    # adds "from future import standard_library"
    # from __future__ import absolute_import etc. on separate lines
    ...
    # Py2.6+
    # this
    # we force adding this import for now, even if it doesn't seem necessary to the fix_future_standard_library fixer, for ease of testing
    # yes, we want this: explicit inheritance from object. Without new-style classes in Py2, super() will break etc.

...
from % import (BytesIO, ZipFile, ZipInfo, %, '__main__':, .compat, .resources,
               .util, =, ==, __name__, detect_encoding, finder, from, if,
               import, import_name, io, logger, logging, logging.getLogger,
               module, os, re, s, struct, sys, sysconfig, time, zipfile)
